...
* Refactored and fixed `Tweak-SysAutoUpdate.sh`
* Changed the bullet styling in `CHANGELOG.MD` file. Bullet characters are now consistent

## 2.1.6

### Modifications

* Shorten the index in Changelog to just the release versions
* Activated Startup Sound fix
* Updated help documentation
* Cleaned up entries

### Deletions

- Removed `Alias` scriptlet

## 2.1.5

### Additions

+ Add `fetchmsttfonts` to font fix scriptlet
+ Add Startup sound fix by enabling Pipewire user services

### Modifications

* Replace Discord with Vencord
* Rename and replace GitHub Desktop with GitHub Desktop Plus

## 2.1.4

### Additions

+ Added KDE Plasma Shader Wallpaper download and install scriptlet

### Modifications

* Modified Personalization scriptlets to use git clone rather than using curl or wget
* Added -y flag to the Cockpit installation script
* Changed Global Theme to MacTahoe by vinceliuice (Thanks!)
